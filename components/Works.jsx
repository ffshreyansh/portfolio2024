      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-10">
        ...
        <Link href={"https://brinjal.vercel.app/"}>
          ...
          <div className='px-8 py-6 flex flex-col items-start justify-between gap-3'>
            ...
            <div className='flex items-center gap-3'>
                <img src="/nextjs.svg" alt="nextjs logo" className=' opacity-50 hover:opacity-100 transition-all' title='NextJs' width={24} />
                <img src="/react.svg" alt="react logo" className=' grayscale hover:grayscale-0 transition-all' title='ReactJs' width={24} />
                <img src="/mongo.svg" alt="mongodb logo" className=' grayscale hover:grayscale-0 transition-all' title='MongoDB' width={24} />
                <img src="/tailwind.svg" alt="tailwindcss logo" className=' grayscale hover:grayscale-0 transition-all' title='Tailwind CSS' width={24} />
                <img src="/nodejs.svg" alt="nodejs logo" className=' opacity-50 hover:opacity-100 transition-all' title='Nodejs' width={24} />
              </div>
        ...
        <div className='flex flex-col items-start h-fit border rounded-xl hover:-mt-1 hover:shadow-md transition-all duration-300' >
          ...
          <div className='px-8 py-6 flex flex-col items-start justify-between gap-3'>
            ...
            <div className='flex items-center gap-3'>
                <img src="/boots.svg" alt="Bootstrap logo" className=' grayscale hover:grayscale-0 transition-all' title='Bootstrap 5' width={20} />
                <img src="/jq.svg" alt="jQuery logo" className=' opacity-50 hover:opacity-100 transition-all' title='jQuery' width={45} />
              </div>
        ...
        <div className='flex flex-col items-start h-fit border rounded-xl hover:-mt-1 hover:shadow-md transition-all duration-300' >
         <Link href={"https://loch-eight.vercel.app/"} target='_blank'>
          <img className='w-full rounded-t-xl' src="/withBg/loch.webp" alt="Project Loch image" width={'100%'} />
          <div className='px-8 py-6 flex flex-col items-start justify-between gap-3'>
            <h6 className='font-bold font-inter text-lg'>Loch - NewsLetter</h6>
            <p className=' leading-snug'>A frontend layout to handle newsletter data, It authenticated user's email and save the email in database.</p>
            <div className='flex items-center gap-3'>
                <img src="/nextjs.svg" alt="nextjs logo" className=' opacity-50 hover:opacity-100 transition-all' title='NextJs' width={24} />
                <img src="/react.svg" alt="react logo" className=' grayscale hover:grayscale-0 transition-all' title='ReactJs' width={24} />
                <img src="/tailwind.svg" alt="tailwindcss logo" className=' grayscale hover:grayscale-0 transition-all' title='Tailwind CSS' width={24} />
        ...
        <div className='flex flex-col items-start h-fit border rounded-xl hover:-mt-1 hover:shadow-md transition-all duration-300' >
          <Link href={"https://www.aussieyouthcare.com.au/"} target='_blank'>
            ...
            <div className='px-8 py-6 flex flex-col items-start justify-between gap-3'>
              ...
              <div className='flex items-center gap-3'>
                <img src="/tailwind.svg" alt="tailwindcss logo" className=' grayscale hover:grayscale-0 transition-all' title='Tailwind CSS' width={24} />
                <img src="/wp.svg" alt="mongodb logo" className=' opacity-50 hover:opacity-100 transition-all' title='MongoDB' width={24} />
              </div>
