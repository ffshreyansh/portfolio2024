        ...
        <div className='w-full lg:w-3/4 mx-auto mt-10 px-4 py-20 lg:px-0 lg:py-20'>
            ...
            <div className='flex flex-col lg:flex-row gap-6 mt-10 items-start justify-between w-full'>
                ...
                >
                    ...
                    <a className='bg-white w-full lg:w-1/2 h-12 rounded-lg font-medium flex items-center justify-center border' href='mailto:hello@shreyanshkr.com?subject=Hello%20Julien!'> Contact me </a>
                </motion.div>
                <motion.div className='w-full lg:w-1/3 bg-yW rounded-xl h-80 flex flex-col items-start justify-between p-8'
                    initial="hidden"
                    animate="visible"
                ...
                >
                    ...
                    <a className='bg-white w-full lg:w-1/2 h-12 rounded-lg font-medium flex items-center justify-center border' href='mailto:hello@shreyanshkr.com?subject=Hello%20Julien!'> Work with me </a>
                </motion.div>
                <motion.div className='w-full lg:w-1/3 bg-yW rounded-xl h-80 flex flex-col items-start justify-between p-8'
                    initial="hidden"
                    animate="visible"
                ...
                >
                    ...
                    <a className='bg-white w-full lg:w-1/2 h-12 rounded-lg flex font-medium items-center justify-center border' href='mailto:hello@shreyanshkr.com?subject=Hello%20Julien!'> Contact me </a>
                </motion.div>
            </div>
