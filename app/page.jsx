...
const Home = () => {
  ...
  return (
      ...
      <section className="flex flex-col justify-center h-screen w-full md:w-1/2 lg:w-1/2 mx-auto relative ">
        ...
        <Link href={'/about'}><motion.img src='/shre-face.png' className='rounded-full w-8 lg:w-16 absolute z-30 right-14 lg:right-12 xl:right-32 -top-2 lg:-top-4 animate-bounce'/></Link>
        </motion.h1>
